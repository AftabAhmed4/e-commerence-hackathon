...
const ProductDetailPage = () => {
            ...
            <div className="px-4 md:px-20 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <h3 className="text-2xl font-bold text-black">RS 25,000.00</h3>
                        ...
                        <p className="text-lg text-gray-700">
                            The T-shirt is crafted with the finest materials to provide comfort and style. Ideal for modern living spaces, this sofa combines luxury with functionality.
                        </p>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4 mt-2">
                                <button className="bg-black py-2 px-4 text-white font-medium rounded-md">XL</button>
  ...
  <div className="space-y-6 px-4 sm:px-20">
    ...
    <p className="text-gray-600 text-justify leading-relaxed">
      The T-shirt combines timeless style with luxurious comfort. Crafted
...
<div className="flex justify-center">
      <button className="text-black border-2 border-black px-10 py-2 text-center my-5">Show More</button>
      </div>
