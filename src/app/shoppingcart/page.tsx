  ...
  <div className="max-w-7xl mx-auto px-4 py-6">
    ...
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 flex-1">
        ...
        {/* <!-- Item 1 --> */}
        <div className="grid py-3 sm:py-0 sm:flex items-center border-b pb-4 mb-4">
      ...
      <Image src={Jense} alt="Ashirt" className="rounded-xl w-24" /> 
        ...
        {/* <!-- Item 3 --> */}
        <div className="grid sm:flex items-center border-b pb-4">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 w-full lg:w-1/3">
        ...
        <div className="grid  sm:flex items-center mb-4">
          <input type="text" placeholder="Add promo code" className="flex-1 px-4 py-2 border rounded-md focus:outline-none"/>
          <button className="ml-2 bg-black text-white px-4 py-2 rounded-md mt-2 sm:mt-0">Apply</button>
        </div>
