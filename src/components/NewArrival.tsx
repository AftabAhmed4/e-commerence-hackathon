...
<div className=" text-center font-black text-xl sm:text-4xl mt-10">
  NEW ARRIVALS 
  <div className="mt-3 flex flex-wrap justify-between px-3 sm:px-8 ">
...
{/* button */}
<div className="text-center items-center mt-6 border-b border-slate-500 mx-4 pb-7 sm:mx-20">
<button className="px-2 py-2 sm:px-6 sm:py-3 border border-gray-300 rounded-full w-40 text-gray-700 hover:bg-gray-200 focus:outline-none">
    View All
  </button>
  </div>
